    ...
    <div className="grid gap-4 p-4 sm:p-6 border border-neutral-200 rounded-2xl bg-white">
      <div className="flex gap-4 items-start">
        ...
        <div className="ml-auto text-center">
          <div className="text-xs text-neutral-600 uppercase">Gate</div>
          <div className="text-2xl font-mono">{summary.gate}</div>
        </div>
      </div>
      <div className="grid gap-1 p-4 rounded-xl bg-neutral-50">
      ...
      <div className="flex flex-col gap-2 md:flex-row">
        <div className="px-4 py-3 rounded-xl bg-neutral-50 grid gap-1">
          <div className="text-xs text-neutral-600 uppercase">Seat</div>
          <div className="text-2xl font-mono leading-none">{summary.seat}</div>
        </div>
        <div className="px-4 py-3 rounded-xl bg-neutral-50 flex-1 grid gap-1">
          <div className="text-xs text-neutral-600 uppercase">Class</div>
          <div className="text-xl leading-none">BUSINESS</div>
        </div>
        <div className="px-4 py-3 rounded-xl bg-neutral-50 grid gap-1">
          <div className="text-xs text-neutral-600 uppercase">Departs</div>
          <div className="text-xl leading-none">{summary.departureTime}</div>
        </div>
        <div className="px-4 py-3 rounded-xl bg-neutral-50 grid gap-1">
          <div className="text-xs text-neutral-600 uppercase">Arrival</div>
