    ...
    <div className="grid gap-4 rounded-2xl border border-neutral-200 bg-white p-4 sm:p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="ml-auto text-center">
          <div className="text-xs uppercase text-neutral-600">Gate</div>
          <div className="font-mono text-2xl">{summary.gate}</div>
        </div>
      </div>
      <div className="grid gap-1 rounded-xl bg-neutral-50 p-4">
      ...
      <div className="flex flex-col gap-2 md:flex-row">
        <div className="grid gap-1 rounded-xl bg-neutral-50 px-4 py-3">
          <div className="text-xs uppercase text-neutral-600">Seat</div>
          <div className="font-mono text-2xl leading-none">{summary.seat}</div>
        </div>
        <div className="grid flex-1 gap-1 rounded-xl bg-neutral-50 px-4 py-3">
          <div className="text-xs uppercase text-neutral-600">Class</div>
          <div className="text-xl leading-none">BUSINESS</div>
        </div>
        <div className="grid gap-1 rounded-xl bg-neutral-50 px-4 py-3">
          <div className="text-xs uppercase text-neutral-600">Departs</div>
          <div className="text-xl leading-none">{summary.departureTime}</div>
        </div>
        <div className="grid gap-1 rounded-xl bg-neutral-50 px-4 py-3">
          <div className="text-xs uppercase text-neutral-600">Arrival</div>
