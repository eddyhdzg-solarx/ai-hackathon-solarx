  ...
  return (
    <div className="-mt-2 flex w-full flex-col gap-2 py-4">
      {placeholderEvents.map(event => (
        ...
        >
          <div className="w-fit rounded-lg bg-neutral-700 text-sm text-transparent">
            {event.date}
          </div>
          <div className="w-fit rounded-lg bg-neutral-700 text-transparent">
            {event.headline}
          </div>
          <div className="w-auto rounded-lg bg-neutral-700 text-transparent">
